...
($ypd_names, $ypd_ids, $ypd_desc, $ypd_ratios, $ypd_pvals) = &read_pvalues_2($ypd_file, $ID_hash);
($mms_names, $mms_ids, $ypd_desc, $mms_ratios, $mms_pvals) = &read_pvalues_2($mms_file, $ID_hash);
